...
const Deal = () => {
  return (
        ...
        <div className=" dark:text-gray-900 w-[85%] mx-auto">
	<div className="container ">
		<div className="flex flex-col lg:flex-row  ">
            ...
            <div className="flex text-[28px]  divide-x-2 my-6 ml-[3.4rem] rounded dark:text-gray-100 divide-white">
	<button type="button" className="px-3 py-1">07 <span className='text-[16px]'>hours</span></button>
	<button type="button" className="px-3 py-1">40 <span className='text-[16px]'>minutes</span></button>
	<button type="button" className="px-3 py-1">24 <span className='text-[16px]'>sec</span></button>
</div>
<button type="button" className="px-8 py-3 mr-[30px] font-semibold text-[16px] border rounded dark:border-gray-100 dark:text-gray-100">SEE ALL THE DEALS OF THE DAY</button>
</div>
		...
		<div className="flex flex-wrap items-center mt-2 mb-2 space-x-2">
			<div className="flex">
				...
				<button type="button" title="Rate 4 stars" aria-label="Rate 4 stars">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6 dark:footer-link">
						<path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
					</svg>
				</button>
			...
			<span className="dark:text-gray-400">(6)</span>
